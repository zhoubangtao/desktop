 ...
 */
Ext.define('Tn.settings.controller.SettingsController', {
    extend: 'Tn.desktop.controller.ModuleController',
    stores: [
        'Tn.settings.store.Wallpapers',
        'Tn.settings.store.Themes'
    ],
    models: [
        'Tn.settings.model.Wallpaper',
        'Tn.settings.model.Theme'
    ],
    views: [
        'Tn.settings.view.SettingsWindow',
    ...
    launch: function() {
        var me = this,
            win = me.getSettingsWin() || me.getDesktop().addWindow({
