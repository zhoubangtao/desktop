 ...
 */
Ext.define('Tn.desktop.util.WindowManager', {
    /**
    ...
    constructor: function(config) {
        ...
        me.modules = Ext.create('Tn.desktop.util.ModuleCollection', {
            listeners: {
                add: me.onAddModule,
                scope: me
            }
    ...
    addWindow: function(options, config) {
        ...
        if(options.alias) {
            ...
            throw 'Unknown property to create new window in Tn.desktop.util.WindowManager::addWindow()';
        }
    ...
    onAddModule: function(i, module, key) {
        var me = this,
            fn = Ext.bind(function(module) {
                Tn.util.Utility.loadCssFile(Tn.util.Utility.getPath(module.controller) + '/../css/module.css');
