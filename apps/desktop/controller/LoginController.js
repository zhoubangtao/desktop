 ...
 */
Ext.define('Tn.desktop.controller.LoginController' ,{
    extend: 'Ext.app.Controller',
    views: [
        'Tn.desktop.view.Login'
    ],
    /**
    ...
    init: function() {
        ...
        if(GLOBAL_USER_LOGGED_IN !== true || !Ext.isDefined(GLOBAL_USER_PROFILE) || !Ext.isObject(GLOBAL_USER_PROFILE)) {
            me.loginWindow = Ext.create('widget.login');
            me.control({
            ...
            me.application.getController('Tn.desktop.controller.DesktopController').bindUser(GLOBAL_USER_PROFILE);
        }
    },
...
//                    me.application.getController('Tn.desktop.controller.DesktopController').bindUser(action.result.userDesktop);
//                },
