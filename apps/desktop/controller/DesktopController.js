/**
 * Controller for a Desktop in desktop
 *
 ...
 */
Ext.define('Tn.desktop.controller.DesktopController' ,{
    extend: 'Ext.app.Controller',
    mixins: {
        manager: 'Tn.desktop.util.WindowManager'
    },
    requires: [
        'Tn.desktop.controller.ModuleController',
        'Tn.desktop.util.ModuleCollection'/*,
        'Ext.ux.data.proxy.ZfProxy'*/
    ],

    views : [ 'Tn.desktop.view.Taskbar',
        'Tn.desktop.view.Wallpaper',
        'Tn.desktop.view.StartMenu',
        'Tn.desktop.view.Desktop'],

    stores: [
        'Tn.desktop.store.Shortcuts'
    ],
    refs: [
        { ref: 'taskBar',       selector: 'desktop-taskbar'},
        { ref: 'startMenu',     selector: 'desktop-startmenu'},
        { ref: 'toolBar',       selector: 'desktop-startmenu toolbar[cls=ux-start-menu-toolbar]'},
        { ref: 'quickStart',    selector: 'desktop-taskbar #ux-desktop-quickstart'},
        { ref: 'windowBar',     selector: 'desktop-taskbar #ux-desktop-windowbar'},
        { ref: 'systemTray',    selector: 'desktop-taskbar #ux-desktop-systemtray'},
        { ref: 'windowBarContextMenu', selector: '#taskbar-contextmenu'},
        { ref: 'viewPort',      selector: 'desktop-viewport'},
        { ref: 'wallpaper',     selector: 'desktop-wallpaper'},
    ...
    publicCss : ['icons.css','filetypes.css'],
    ...
    init: function() {
        ...
        me.loadPublicCss(me.publicCss);

        me.mixins.manager.constructor.call(this, {desktop: me});

        me.shortcuts  = Ext.data.StoreManager.get('Tn.desktop.store.Shortcuts'); //FIXME: see @todo of variable definition, replace with getter
        ...
        me.control({
            ...
            'desktop-taskbar #ux-desktop-quickstart': {
                beforeadd: me.onBeforeAddQuickstart
            },
            'desktop-taskbar #ux-desktop-quickstart > button': {
                click: me.onClickModuleHandler
            },
            'desktop-startmenu menu menuitem': {
                click: me.onClickModuleHandler
            },
            'desktop-startmenu toolbar[dock=right] button': {
                click: me.onClickModuleHandler
            },
    ...
    loadPublicCss : function(cssFiles) {
      var me = this;
      if(cssFiles) {
        if(Ext.isArray(cssFiles)) {
          Ext.each(cssFiles, me.application.loadCssFile, me.application);
        } else {
          me.application.loadCssFile(cssFiles);
        }
      }
    },
    ...
    bindUser: function(config) {
        ...
        Ext.each(launchers.autorun, function(item) {
            ...
            var cn = me.application.getController(module.controller);
                if(!cn.isInit) {
